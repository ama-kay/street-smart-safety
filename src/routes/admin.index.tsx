...
const stats = [
  { label: "Total Users", value: "2,847", icon: Users, change: "+12%", color: "text-info", bg: "bg-info-soft" },
  { label: "Active Emergencies", value: "3", icon: Radio, change: "", color: "text-emergency", bg: "bg-emergency-soft" },
  { label: "Alerts Today", value: "18", icon: AlertTriangle, change: "+5", color: "text-warning", bg: "bg-warning-soft" },
  { label: "Cancelled Alerts", value: "7", icon: XCircle, change: "", color: "text-muted-foreground", bg: "bg-muted" },
];
            ...
            <div className="bg-card rounded-lg border border-border">
                ...
                <tbody>
                    ...
                    <tr key={i} className="border-b last:border-0 border-border hover:bg-secondary/30 transition-colors">
                        ...
                        <span className={`text-xs font-medium px-2.5 py-1 rounded-full ${statusStyles[alert.status]}`}>
                            {alert.status}
                        </span>
                        </td>
                    </tr>
